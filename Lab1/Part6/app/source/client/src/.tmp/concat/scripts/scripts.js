...
angular.module('clientApp')
  .constant('Constants', {
    ...
    AUTH_MANAGER_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    USER_MANAGER_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    TENANT_MANAGER_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    TENANT_REGISTRATION_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    PRODUCT_MANAGER_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    ORDER_MANAGER_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
    SYSTEM_REGISTRATION_URL: 'https://1klylzxi8c.execute-api.us-west-2.amazonaws.com/prod',
